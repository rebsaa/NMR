...
rule Diamond: 
    ...
    params:
        INFILE="Results/Trinity/{species}/{sample}/Diamond/Diamond_input.pep",
    ...
    shell:
        ...
        diamond blastp -q {params.INFILE} -o {params.DIR}out_$DB.tsv -d Diamond/$DB.dmnd -p 12 --very-sensitive --max-target-seqs 1
